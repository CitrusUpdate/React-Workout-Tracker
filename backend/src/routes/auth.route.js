...
import { signup, login, logout, updateProfile, updateTimezone } from "../controllers/auth.controller.js"
...
router.patch("/timezone", protectRoute, arcjetProtection(ajAuth), updateTimezone);
